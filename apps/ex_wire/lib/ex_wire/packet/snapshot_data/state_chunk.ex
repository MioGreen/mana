defmodule ExWire.Packet.SnapshotData.StateChunk do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> %ExWire.Packet.SnapshotData.StateChunk{
      ...>   account_entries: [
      ...>     {
      ...>       <<1::256>>,
      ...>       %ExWire.Packet.SnapshotData.StateChunk.RichAccount{
      ...>         nonce: 2,
      ...>         balance: 3,
      ...>         code_flag: :has_code,
      ...>         code: <<5::256>>,
      ...
      ...>   ]
      ...> }
      ...> |> ExWire.Packet.SnapshotData.StateChunk.serialize()
      [
        [ <<1::256>>,
          [
            2,
  ...
  ## Examples
      ...
      ...>   ]
      ...> ]
      ...> |> ExWire.Packet.SnapshotData.StateChunk.deserialize()
      %ExWire.Packet.SnapshotData.StateChunk{
        account_entries: [
          {
            <<1::256>>,
            %ExWire.Packet.SnapshotData.StateChunk.RichAccount{
      ...
      for [hash, rich_account_rlp] <- account_entries_rlp do
        ...
        {hash,
         %RichAccount{
           nonce: nonce,
           balance: balance,
           code_flag: RichAccount.decode_code_flag(encoded_code_flag),
           code: code,
           storage: storage
         }}
      end
