defmodule ExWire.Packet.SnapshotData.BlockChunk do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> %ExWire.Packet.SnapshotData.BlockChunk{
      ...>   number: 5,
      ...>   hash: <<6::256>>,
      ...>   total_difficulty: 7,
      ...>   block_data_list: [
      ...>     %ExWire.Packet.SnapshotData.BlockChunk.BlockData{
      ...>       header: %ExWire.Packet.SnapshotData.BlockChunk.BlockHeader{
      ...>         author: <<10::160>>,
      ...>         state_root: <<11::256>>,
      ...>         logs_bloom: <<12::2048>>,
      ...>         difficulty: 13,
      ...
      ...>   ]
      ...> }
      ...> |> ExWire.Packet.SnapshotData.BlockChunk.serialize()
      [
        5,
        <<6::256>>,
        7,
  ...
  ## Examples
      ...
      ...>   ]
      ...> ]
      ...> |> ExWire.Packet.SnapshotData.BlockChunk.deserialize()
      %ExWire.Packet.SnapshotData.BlockChunk{
        number: 5,
        hash: <<6::256>>,
        total_difficulty: 7,
        block_data_list: [
